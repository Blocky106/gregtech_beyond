...
astro_mining_station.recipeMap.recipeBuilder()
    ...
    .fluidInputs(<liquid:olefin_drilling_mud>*16000)
    .EUt(1200)
    .duration(200)
    .buildAndRegister();
...
astro_mining_station.recipeMap.recipeBuilder()
    ...
    .outputs(<gregtech:ore_uranium_radioactive_0>,<gregtech:ore_uranium_0>,<gregtech:ore_pitchblende_0>)
    .fluidInputs(<liquid:olefin_drilling_mud>*16000)
    .EUt(1200)
    .duration(200)
    .buildAndRegister();
...
astro_mining_station.recipeMap.recipeBuilder()
    ...
    .fluidInputs(<liquid:olefin_drilling_mud>*32000)
    .EUt(1200)
    .duration(300)
    .buildAndRegister();
...
astro_mining_station.recipeMap.recipeBuilder()
    ...
    .notConsumable(<contenttweaker:mars>)
    .outputs(<gregtech:ore_gallite_0>*5,<gregtech:ore_arsenopyrite_0>*5)
    .fluidInputs(<liquid:olefin_drilling_mud>*16000)
    .EUt(1200)
    .duration(200)
    .buildAndRegister();
