...
lcentrifuge.recipeBuilder()
    ...
    .outputs(<contenttweaker:monazite_sulfate>,<gregtech:meta_item_1:2159>,<gregtech:meta_item_1:2122>,<gregtech:meta_item_1:2121>,<gregtech:meta_item_1:2713>)
    .duration(400)
    .EUt(1200)
    .buildAndRegister();
...
lcentrifuge.recipeBuilder() 
    ...
    .outputs(<contenttweaker:thorium_phosphate_cake>*2,<contenttweaker:rare_earth_filtrate>*2)
    .duration(99)
    .EUt(2000)
    .buildAndRegister();
...
ebf.recipeBuilder()
    .inputs(<contenttweaker:thorium_phosphate_cake>)
    .outputs(<contenttweaker:thorium_phosphate_concentrate>)
    .duration(800)
    .EUt(2000)
...
lcr.recipeBuilder()
    ...
    .outputs(<gregtech:meta_item_1:2050>,<contenttweaker:neutralized_rare_earth_filtrate>)
    .inputs(<contenttweaker:rare_earth_filtrate>)
    .duration(400)
    .EUt(480)
    .buildAndRegister();

centrifuge.recipeBuilder()
    .inputs(<contenttweaker:neutralized_rare_earth_filtrate>*2)
    .fluidOutputs(<liquid:rare_earth_hydroxides_solution>*1000)
    .outputs(<contenttweaker:uranium_filtrate_dust>)
    .duration(600)
    .EUt(480)
    .buildAndRegister();

centrifuge.recipeBuilder()
    .inputs(<contenttweaker:uranium_filtrate_dust>*2)
    .outputs(<contenttweaker:uranium_concentrate_dust>)
    .duration(2900)
    .EUt(800)
    .buildAndRegister();
