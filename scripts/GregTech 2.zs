...
mixer.recipeBuilder()
    .inputs(<gtadditions:ga_dust:32189>,<gregtech:meta_item_1:2062>*2)
...
chemReactor.recipeBuilder()
    ...
    .outputs(<gregtech:meta_item_1:2772>*2, <gtadditions:ga_dust:32231>)
    .duration(200)
    .EUt(480)
    .buildAndRegister();
...
assembly_line.recipeBuilder()
    ...
    .outputs(<gtadditions:ga_cryostat_casing:4>)
...
assembly_line.recipeBuilder()
    ...
    .outputs(<gtadditions:ga_divertor_casing:4>)
    .fluidInputs(<liquid:zylon>*2000,<liquid:cinobite_molten>*2000)
    .duration(400)
    .EUt(400000)
    .buildAndRegister();
...
assembly_line.recipeBuilder()
    ...
    .outputs(<gtadditions:ga_vacuum_casing:4>)
    .duration(400)
    .EUt(800000)
...
mixer.recipeBuilder()
    .inputs(<extendedcrafting:material:7>,<gregtech:meta_item_1:2532>,<gregtech:meta_item_1:2111>*2)
...
assembler.recipeBuilder()
    ...
    .notConsumable(<gregtech:meta_item_1:32766>.withTag({Configuration: 26}))
