...
recipes.addShaped(<forestry:carpenter>, [	[<ore:plateBronze>, <gregtech:machine_casing:10>, <ore:plateBronze>], 	[<ore:plateBronze>, <contenttweaker:servo>, <ore:plateBronze>], 	[<forestry:impregnated_casing>, <contenttweaker:engine>, <forestry:impregnated_casing>]]);
